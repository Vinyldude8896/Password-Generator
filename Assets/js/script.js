// assigning possible character sets based on user inputs
var lowercaseCharSet = "abcdefghijklmnopqrstuvwxyz";
var uppercaseCharSet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
var numericCharSet = "0123456789";
var specialCharset = "~`! @#$%^&*()_-+={[}]|;'<>.?/";

// generating password function - whoch includes input functions from user
var generatePassword = function () {
  ...
  // this is the storage object for user password based in input values and validation         
          var UserPassword ={
  ...
  // Actual password generating starts here with concating strings
...
// Write password to generate password window after all user input is completed
